...
public class CategoryCity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_categories.setText(R.string.category_city);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    Intent intent = new Intent(CategoryCity.this, Categories.class);
        ...
        //анимация - начало
        final Animation a = AnimationUtils.loadAnimation(CategoryCity.this, R.anim.alpha);
        ...
        img_centre.setImageResource(array.images2[numCentre]); //достаем из массива картинку
        ...
        if (numLeft<numCentre) {
            text_card.setText(array.texts2[numRight]);
            saveNum = 1;


        } else if (numCentre>numRight) {
            text_card.setText(array.texts2[numCentre]);
            saveNum = 2;


        } else {
            text_card.setText(array.texts2[numLeft]);
            saveNum = 3;
