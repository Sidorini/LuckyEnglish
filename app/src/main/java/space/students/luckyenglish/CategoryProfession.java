...
public class CategoryProfession extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_categories.setText(R.string.category_profession);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    Intent intent = new Intent(CategoryProfession.this, Categories.class);
        ...
        //анимация - начало
        final Animation a = AnimationUtils.loadAnimation(CategoryProfession.this, R.anim.alpha);
        ...
        img_centre.setImageResource(array.images9[numCentre]); //достаем из массива картинку
        ...
        if (numLeft<numCentre) {
            text_card.setText(array.texts9[numRight]);
            saveNum = 1;


        } else if (numCentre>numRight) {
            text_card.setText(array.texts9[numCentre]);
            saveNum = 2;


        } else {
            text_card.setText(array.texts9[numLeft]);
            saveNum = 3;
