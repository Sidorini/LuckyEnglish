...
public class CategoryClothes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_categories.setText(R.string.category_clothes);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    Intent intent = new Intent(CategoryClothes.this, Categories.class);
        ...
        //анимация - начало
        final Animation a = AnimationUtils.loadAnimation(CategoryClothes.this, R.anim.alpha);
        ...
        img_centre.setImageResource(array.images7[numCentre]); //достаем из массива картинку
        ...
        if (numLeft<numCentre) {
            text_card.setText(array.texts7[numRight]);
            saveNum = 1;


        } else if (numCentre>numRight) {
            text_card.setText(array.texts7[numCentre]);
            saveNum = 2;


        } else {
            text_card.setText(array.texts7[numLeft]);
            saveNum = 3;
