...
public class CategoryHouse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_categories.setText(R.string.category_house);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    Intent intent = new Intent(CategoryHouse.this, Categories.class);
        ...
        //анимация - начало
        final Animation a = AnimationUtils.loadAnimation(CategoryHouse.this, R.anim.alpha);
        ...
        img_centre.setImageResource(array.images3[numCentre]); //достаем из массива картинку
        ...
        if (numLeft<numCentre) {
            text_card.setText(array.texts3[numRight]);
            saveNum = 1;


        } else if (numCentre>numRight) {
            text_card.setText(array.texts3[numCentre]);
            saveNum = 2;


        } else {
            text_card.setText(array.texts3[numLeft]);
            saveNum = 3;
