...
public class CategoryWeather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_categories.setText(R.string.category_weather);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    ...
                    Intent intent = new Intent(CategoryWeather.this, Categories.class);
        ...
        //анимация - начало
        final Animation a = AnimationUtils.loadAnimation(CategoryWeather.this, R.anim.alpha);
        ...
        img_centre.setImageResource(array.images8[numCentre]); //достаем из массива картинку
        ...
        if (numLeft<numCentre) {
            text_card.setText(array.texts8[numRight]);
            saveNum = 1;


        } else if (numCentre>numRight) {
            text_card.setText(array.texts8[numCentre]);
            saveNum = 2;


        } else {
            text_card.setText(array.texts8[numLeft]);
            saveNum = 3;
